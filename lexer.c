...
VV_LOCAL_SYMBOL int compare_15639264217551199832_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
VV_LOCAL_SYMBOL void lexer__do_cool_stuff(void);
VV_EXPORTED_SYMBOL void do_cool_stuff(void); // exported fn lexer.do_cool_stuff
...
string string_replace_each(string s, Array_string vals) {
	...
	qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_15639264217551199832_RepIndex_by_idx);
	byte* b = malloc_noscan(new_len + 1);
	int idx_pos = 0;
...
// Attr: [export]
VV_LOCAL_SYMBOL void lexer__do_cool_stuff(void) {
	println(_SLIT("hello from v!"));
}
// export alias: do_cool_stuff -> lexer__do_cool_stuff
void do_cool_stuff(void) {
	return lexer__do_cool_stuff();
}
...
void _vinit(int ___argc, voidptr ___argv) {
	...
	{ // Initializations for module lexer :
	}
}
void _vcleanup(void) {
}
